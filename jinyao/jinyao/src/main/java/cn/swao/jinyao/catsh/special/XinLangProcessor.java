...
public class XinLangProcessor implements PageProcessor {
	...
	// 需要格式化的参数
	private static final String FORMAT_START_URL_ARGS = "pageid=1&lid=21&num=" + PAGE_SIZE
			+ "&versionNumber=1.2.8&encode=utf-8&page=%s";
	...
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		spider = Spider.create(new XinLangProcessor()).addPipeline(new ConsolePipeline())
				.addPipeline(new JsonFilePipeline("d:/news/xinlang/keji")).addUrl(startUrl).thread(100);
		spider.start();
	}
