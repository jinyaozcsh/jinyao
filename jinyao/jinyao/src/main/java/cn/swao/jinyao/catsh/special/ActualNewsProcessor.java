...
import cn.swao.jinyao.catsh.StartCatchService;
...
public class ActualNewsProcessor implements PageProcessor {
    ...
    // 保存数据
    // public void save(String newstitle, String newsimg, String newszy, String newstime, String name, String content, String date, String code) {
    ...
    public interface IActualNewsSave {
        void actualNewsSave(String newstitle, String newsimg, String newszy, String newstime, String newslink, String name, String content, String date, String code);
    }

    public void setIActualNewsSave(IActualNewsSave saveCallBack) {
