...
public class CashNews implements PageProcessor {
    ...
    private String[] urls = { "http://temp.163.com/special/00804KVA/cm_yaowen.js", "http://public.house.163.com/special/03531F4E/index_news.js", "http://temp.163.com/special/00804KVA/cm_shehui.js", "http://temp.163.com/special/00804KVA/cm_guonei.js", "http://temp.163.com/special/00804KVA/cm_guoji.js", "http://temp.163.com/special/00804KVA/cm_dada.js", "http://temp.163.com/special/00804KVA/cm_dujia.js", "http://temp.163.com/special/00804KVA/cm_war.js", "http://temp.163.com/special/00804KVA/cm_money.js", "http://temp.163.com/special/00804KVA/cm_tech.js", "http://temp.163.com/special/00804KVA/cm_sports.js", "http://temp.163.com/special/00804KVA/cm_ent.js", "http://temp.163.com/special/00804KVA/cm_lady.js", "http://temp.163.com/special/00804KVA/cm_auto.js",
            "http://temp.163.com/special/00804KVA/cm_houseshanghai.js", "http://temp.163.com/special/00804KVA/cm_hangkong.js", "http://temp.163.com/special/00804KVA/cm_jiankang.js" };
   ...
   /* public static void main(String[] args) throws MalformedURLException, IOException {
        new CashNews().getUrls();
        read();
        Spider.create(new CashNews()).addUrl("http://news.163.com/").addPipeline(new JsonFilePipeline("D:/FilesOutput/")) .setDownloader(new SeleniumDownloader("E:/work/package/chromedriver.exe")) .thread(5).start();
    }*/
    ...
    public void process(Page page) {
        if (page.getUrl().get().equals("http://news.163.com/")) {
            // List<String> all = page.getHtml().xpath("//*[@id=\"index2016_wrap\"]/div[2]/div[2]/div[3]/div[2]/div[5]/div/ul/li[1]/div").links().all();
            page.addTargetRequests(detailUrl);
        } else {
            /*
             * try { Json json = page.getJson(); String rawText = json.removePadding("data_callback").get(); JsonArray parse = JSONUtils.parseArray(rawText); Iterator<JsonElement> it = parse.iterator(); while (it.hasNext()) { JsonElement next = it.next(); String docurl = next.getAsJsonObject().get("docurl").getAsString(); String commenturl = next.getAsJsonObject().get("commenturl").getAsString(); if (!Strings.isStringEmpty(docurl)) { Map<String, String> sourceUrl = new HashMap<String, String>(); sourceUrl.put("docurl", docurl); sourceUrl.put("commenturl", commenturl); sourceUrl.put("sourceUrl", page.getUrl().get()); putFile("D:/news.txt", JSONUtils.toJson(sourceUrl)); } } } catch (Exception e) { e.printStackTrace(); page.setSkip(true); System.out.println(page.getUrl().get()); } }
             */
